...
abstract: 
사지연장술은 뼈를 연장하여 팔다리의 길이를 늘리는 수술입니다. 이 수술은 주로 선천적인 기형이나 외상으로 인한 팔다리의 불균형을 교정하거나, 개인의 신체적인 이유로 키를 늘리기 위해 시행됩니다. 이를 가능하게 하는 핵심 원리는 뼈의 재생 능력을 활용하는 것이며, 연장술은 이를 효과적으로 이용하는 수술 방법입니다.
