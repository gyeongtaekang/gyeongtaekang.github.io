      ...
      slides:
        - title: "<span style=\"font-size:70%\">공모전</span>"
          ...
          link:
            ...
            icon_pack: fas
            text: "<br>{{% cta cta_link=\"https://unsplash.com/ko/%EC%82%AC%EC%A7%84/%EC%88%B2-%EC%86%8D-%EC%98%A4%EC%86%94%EA%B8%B8-GraajutbJHE\" cta_text=\"Image 출처: Unsplash\" %}}"
            text-color: '#fff'
        ...
        - title: "<span style=\"font-size:70%\">코딩</span>"
          ...
          link:
            icon: external-link-alt
            icon_pack: fas
            text: "<br>{{% cta cta_link=\"https://unsplash.com/ko/%EC%82%AC%EC%A7%84/%ED%91%B8%EB%A5%B8-%EB%B3%84%EC%9D%B4-%EB%B9%9B%EB%82%98%EB%8A%94-%EB%B0%A4-1OtUkD_8svc\" cta_text=\"Image 출처: Unsplash\" %}}"
            text-color: '#fff'
        ...
        - title: "<span style=\"font-size:70%\">런닝</span>"
          ...
          link:
            icon: external-link-alt
            icon_pack: fas
            text: "<br>{{% cta cta_link=\"https://unsplash.com/ko/%EC%82%AC%EC%A7%84/%EC%BD%98%ED%81%AC%EB%A6%AC%ED%8A%B8-%EB%8F%84%EB%A1%9C%EB%A5%BC-%EB%8B%AC%EB%A6%AC%EB%8A%94-%EC%82%AC%EB%9E%8C-Apj4nSemkzk\" cta_text=\"Image 출처: Unsplash\" %}}"
            text-color: '#fff'
